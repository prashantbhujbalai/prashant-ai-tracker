...
# Bulk Upload Section
st.sidebar.subheader("📂 Bulk Upload Clients")
bulk_file = st.sidebar.file_uploader("Upload Excel or CSV", type=["xlsx", "csv"])
...
if bulk_file is not None:
    try:
        ...
        for index, row in df.iterrows():
            ...
            pan = row['PAN']
            gstin = row['GSTIN']
            types = row['Compliance Types'].split(',')
            freq = row['Frequency']
        ...
        conn.commit()
        st.success("✅ Bulk clients uploaded successfully.")
